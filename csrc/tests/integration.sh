...
timeout 30 ./ncp recv --port 9001 received_files/ &
RECV_PID=$!
...
./ncp send --host 127.0.0.1 --port 9001 test_files/test.txt
...
timeout 30 ./ncp recv --port 9005 --overwrite yes received_files/ &
RECV_PID=$!

sleep 1

echo "Sending directory..."
./ncp send --host 127.0.0.1 --port 9005 test_files/test_dir
...
timeout 30 ./ncp recv --port 9002 received_files/ &
RECV_PID=$!

sleep 1

echo "Sending large file..."
./ncp send --host 127.0.0.1 --port 9002 test_files/large.bin
...
timeout 20 ./ncp recv --port 9003 --overwrite yes received_files/test_overwrite.txt &
RECV_PID=$!

sleep 1

echo "Sending file to specific destination..."
./ncp send --host 127.0.0.1 --port 9003 test_files/test.txt
